...
class TestMockProvider(unittest.TestCase):
    ...
    def setUp(self):
        ...
        logging.getLogger("pydantic_llm_tester").setLevel(logging.DEBUG)
    ...
    @patch('pydantic_llm_tester.utils.config_manager.ConfigManager._load_config')
    ...
    def test_mock_provider_in_registry(self, mock_read_json, mock_fetch, mock_store_models, mock_load_config):
        ...
        # Mock _load_config to return a config with mock provider enabled
