...
# Removed _display_model_status and _prompt_for_model_name as they were related to LLM model config management
# Removed _manage_llm_models_menu as it was related to LLM model config management
# Removed _prompt_for_model_config as it was related to LLM model config management
...
def _run_tests_interactive():
    ...
    try:
        ...
        success = test_runner_logic.run_test_suite(
            ...
            optimize=optimize,
            test_name_filter=None # Not prompting for this yet
        )
...
# Removed _manage_llm_models_config_menu as it was related to LLM model config management
...
def start_interactive_session():
    ...
    while True:
        ...
        # Removed menu option 9: "9. Manage LLM Models"
        print("0. Exit")
